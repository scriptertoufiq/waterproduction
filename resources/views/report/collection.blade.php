                ...
                <div class="col-lg-12">
                    <section class="card">
                        ...
                        <div class="card-body">
                            ...
                            {!! Form::open(['route' => 'moneyCollectionSearch', 'method' => 'GET', 'files' => 'true', 'enctype' => 'multipart/form-data']) !!}
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        @if ($searchresult)
                                            @foreach ($searchresult as $collection)
                                                @php
                                                    $n = 1;
                                                @endphp
                                                <tr>
                                                    <td>{{ $n++ }}</td>
                                                    <td>{{$collection->StaffData->name}}</td>
                                                    <td>{{$collection->ClientData->name}}</td>
                                    ...
                                    <tfoot>
                                        <td colspan="2" style="background: black;color: white">Total Collection</td>
