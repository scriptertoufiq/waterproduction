                ...
                <div class="col-lg-12">
                    <section class="card">
                        ...
                        <div class="card-body">
                            ...
                            {!! Form::open(['route' => 'clientReportSearch', 'method' => 'GET', 'files' => 'true', 'enctype' => 'multipart/form-data']) !!}
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3 col-lg-3 col-sm-3 ">
                                    @php
                                        $cilent = App\Models\Client::pluck('name','id');
                                    @endphp
                                    {{ Form::label('client', ' Client :') }}
                                    {{ Form::select('client', $cilent, null, ['class' => 'form-control', 'id' => 'client', 'placeholder' => 'Select Client ']) }}
                                </div>
