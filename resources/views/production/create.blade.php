                ...
                <div class="col-lg-12">
                    <section class="card">
                        <header class="card-header" style="color: Black;text-transform: capitalize;font-weight: bold; ">
                            Add Water Production Information
                        ...
                        <div class="card-body">
                            {!! Form::open(['route' => 'productions.store', 'files' => 'true', 'enctype' => 'multipart/form-data']) !!}

                            <div class="row">
                                <div class="form-group col-md-5 col-lg-5 col-sm-5">
                                    {!! Html::decode(Form::label('bottle_id', 'Bottle: <sup style="color:red;">*</sup>')) !!}
                                    {{ Form::select('bottle_id', $bottle, null, ['class' => 'form-control', 'id' => 'bottle_id', 'placeholder' => 'Select Bottle ', 'required']) }}
                                </div>
                                <div class="form-group col-md-2 col-lg-2 col-sm-2">
                                    ...
                                    {{ Form::text('available_bottle', null, ['class' => 'form-control', 'id' => 'available_bottle', 'placeholder' => 'Your Available Bottles', 'disabled']) }}
                                </div>
                                <div class="form-group col-md-5 col-lg-5 col-sm-5">
